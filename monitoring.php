...
$pageTitle = $configData['pages']['monitoring.php']['name'] ?? 'ALARM';

if (session_status() === PHP_SESSION_NONE) {
    session_start();
}
$currentRole = $_SESSION['role_level'] ?? 10;
$allowedRoles = $configData['pages']['monitoring.php']['roles'] ?? [99, 50, 10, 0];
if ('monitoring.php' !== 'index.php' && !in_array($currentRole, $allowedRoles) && $currentRole < 99) {
