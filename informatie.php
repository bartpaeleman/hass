...
$pageTitle = $configData['pages']['informatie.php']['name'] ?? 'INFORMATIE';

if (session_status() === PHP_SESSION_NONE) {
    session_start();
}
$currentRole = $_SESSION['role_level'] ?? 10;
$allowedRoles = $configData['pages']['informatie.php']['roles'] ?? [99, 50, 10, 0];
if ('informatie.php' !== 'index.php' && !in_array($currentRole, $allowedRoles) && $currentRole < 99) {
