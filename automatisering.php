...
$pageTitle = $configData['pages']['automatisering.php']['name'] ?? 'AUTOMATISERING';

if (session_status() === PHP_SESSION_NONE) {
    session_start();
}
$currentRole = $_SESSION['role_level'] ?? 10;
$allowedRoles = $configData['pages']['automatisering.php']['roles'] ?? [99, 50, 10, 0];
if ('automatisering.php' !== 'index.php' && !in_array($currentRole, $allowedRoles) && $currentRole < 99) {
